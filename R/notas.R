...
# max leeftijd toevoegen in init_pop functie (maximum 15 jaar)
...
# eindpopulatie alle ongebruikte kolommen verwijderen (coordinaten , enz)

# 1 januari of beter een andere startdatum?

# reproduce -> mortality -> hunting -> (aging)

# df_harvest -> volledige populatie informatie (boar - who dies) bijhouden.
# + sim,scenario, tijdstap
# pas later eventueel samenvatting.

# ??? fertility ook * overleving female op maandbasis? (analoog aan jaarlijks populatiemodel) ???

# dependent juveniles moet voor males altijd 0 zijn. Waarom is dat niet het gevel in scen_7b
